...
namespace YoutubeChannel
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=UdemyYoutubeChannel;Integrated Security=True");
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show("İşlem başarılı video eklendi..","Bilgi",MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
        void videolar()
        {
